...
<head>
    ...
    <!-- Scripts -->
    <!-- ini udah ambil bootstrap, trus kenapa di panggil lagi, makanya dia konflik karena ada 2 bootstrap -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li>
                            <a href="/outlet/5" class="nav-link text-warning" style="text-decoration: none; margin-right:15px">Menu</a>
                        </li>
                        @guest
                            @if (Route::has('login'))
                                <li class="nav-item">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a href="/income" class="dropdown-item">Pendapatan</a>
